export default {
  ...
  // The background of the top navigation bar.
    $navBarBackgroundColor: '#ea5920', //#FAFAFA

  // The color of the top navigation bar buttons.
    $navBarButtonColor: '#242424',
  ...
  $bottomTabsTextColor: '#888888',
    $bottomTabsSelectedTextColor: '#ea5920',//#000
  $bottomTabsIconColor: '#888888',
    $bottomTabsSelectedIconColor: '#ea5920',
  ...
  // It is not visible by default.
    $productBorderColor: '#D3D3D3',

  // Border color for menu items.
    $menuItemsBorderColor: '#D3D3D3',
  ...
  // Category background color.
    $categoriesBackgroundColor: '#ea5920',//10b9e4
